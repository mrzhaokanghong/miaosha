...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderModel createOrder(Integer userId, Integer itemId, Integer amount,Integer promoId) throws BusinessException {
        ...
        if(promoId != null){
            ...
            if(promoId.intValue() != itemModel.getPromoModel().getId()){
                throw new BusinessException(EmBusinessError.PARAMETER_VALIDATION_ERROR,"活动商品信息不存在!");
                //校验活动是否正在进行中
        ...
        //生成交易流水号
        orderModel.setId(generateOraderNo());
    ...
    @Transactional(propagation = Propagation.REQUIRES_NEW)
      String generateOraderNo(){
        //订单号规则 16位  前8位为时间信息年月日
